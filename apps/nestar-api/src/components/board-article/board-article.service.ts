...
export class BoardArticleService {
  ...
  public async createBoardArticle(memberId: Schema.Types.ObjectId, input: BoardArticleInput): Promise<BoardArticle> {
  ...
  public async getBoardArticle(memberId: Schema.Types.ObjectId, articleId:Schema.Types.ObjectId): Promise<BoardArticle> {
  const search: T = {
    _id: articleId,
...
public async updateBoardArticle(memberId: Schema.Types.ObjectId, input: BoardArticleUpdate): Promise<BoardArticle> {
...
public async getBoardArticles(memberId: Schema.Types.ObjectId, input: BoardArticlesInquiry): Promise<BoardArticles> {
 ...
 public async likeTargetBoardArticle(memberId: Schema.Types.ObjectId, likeRefId: any): Promise<BoardArticle>{
...
public async removeBoardArticleByAdmin(articleId: Schema.Types.ObjectId): Promise<BoardArticle> {
